...
public class FluidTankBlockScreen extends AbstractContainerScreen<FluidTankBlockMenu> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(Alkomod.MOD_ID, "textures/gui/screen/example_fluid.png");

    public FluidTankBlockScreen(FluidTankBlockMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
